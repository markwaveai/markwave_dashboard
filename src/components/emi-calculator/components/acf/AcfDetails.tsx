...
import { Check, Info, Calendar, CheckCircle2, CircleDollarSign, Clock, AlertCircle } from 'lucide-react';
        ...
        <div className="space-y-6 mt-8">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-blue-100">
                ...
                <div className="bg-blue-900 px-6 py-4">
                    <h3 className="text-white font-bold text-lg text-center">ACF Option</h3>
                </div>
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-500 font-medium">{formatCurrency(projectedAssetValue)}</p>
                        </div>
                    </div>
                            ...
                            <div className="flex justify-between items-start">
                                <div>
                                    ...
                                    <div className="flex items-center gap-2">
                                        <span className="text-gray-400 line-through text-sm">{formatCurrency(totalMarketPrice)}</span>
                                        <span className="text-green-600 font-bold text-lg">{formatCurrency(acfTotalInvestment)}</span>
                                    </div>
                                </div>
                                <BonusBadge />
                            </div>
                        ...
                        <div className="flex-1">
                            <div className="flex justify-between items-start">
                                <div>
                                    ...
                                    <p className="text-gray-500 text-sm">The Unit price is fixed for the complete tenure</p>
                                </div>
                                <BonusBadge />
                            </div>
                        </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                <div className="flex items-center gap-2 mb-8">
                    ...
                    <div>
                        <h3 className="font-bold text-gray-900">Revenue Timeline</h3>
                        <p className="text-xs text-gray-500">Key milestones for your investment</p>
                    </div>
                </div>

                <div className="relative pl-4 space-y-8">
                    {/* Vertical Line */}
                    <div className="absolute left-[27px] top-3 bottom-3 w-0.5 bg-gray-100" />
...
const BonusBadge = () => (
    <div className="flex items-center gap-1 bg-yellow-100 px-2 py-0.5 rounded text-[10px] font-bold text-yellow-700 uppercase tracking-wide">
        <span>✨ BONUS</span>
    </div>
);
...
const TimelineItem: React.FC<TimelineItemProps> = ({ icon: Icon, iconBg, iconColor, label, title, description }) => (
    <div className="relative flex items-start gap-4">
        <div className={clsx("relative z-10 p-2 rounded-full ring-4 ring-white", iconBg)}>
            <Icon className={clsx("w-5 h-5", iconColor)} />
        </div>
        <div>
            <span className={clsx("text-xs font-semibold px-2 py-0.5 rounded mb-1 inline-block", iconBg, iconColor)}>
                {label}
            </span>

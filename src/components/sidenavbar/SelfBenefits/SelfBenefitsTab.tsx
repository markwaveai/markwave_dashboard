...
const SelfBenefitsTab: React.FC = () => {
    ...
    return (
        <div className="flex flex-col h-full bg-[#f4f7fa] p-8 min-h-screen font-sans">
            {/* Header */}
            <div className="flex justify-between items-start mb-10">
                <div>
                    <h2 className="text-[2rem] font-extrabold text-[#111827] leading-tight">
                        Self Benefits Management
                    </h2>
            ...
            {/* Actions & Search Bar */}
            <div className="bg-white p-4 rounded-[1.5rem] shadow-sm mb-8 border border-[#f1f5f9] flex flex-wrap items-center justify-between gap-4">
                    ...
                    filteredBenefits.map((benefit) => (
                        ...
                        >
                            ...
                            <div className="flex-shrink-0 flex flex-col items-center gap-2 ml-auto pl-6 border-l border-[#f1f5f9] self-center">
                                {benefit.is_active ? (
                                    <div className="px-2.5 py-1 bg-[#10b981]/10 text-[#10b981] text-[9px] font-black uppercase rounded-lg tracking-wider border border-[#10b981]/20">
                                        ACTIVE
                                    </div>
                                ) : (
                                    <div className="px-2.5 py-1 bg-slate-50 text-slate-400 text-[9px] font-black uppercase rounded-lg tracking-wider border border-slate-200">
                                        INACTIVE
                                    </div>
                                )}
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-1 px-3 py-1.5 bg-slate-50 hover:bg-slate-100 text-[#334155] hover:text-[#10b981] font-bold text-[10px] rounded-lg border border-slate-200 transition-all active:scale-95"
                                >
                                    <Edit2 size={12} />
                                    EDIT
                                </button>
